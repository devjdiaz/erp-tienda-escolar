...
export function Sidebar({ role, active, onNavigate }: SidebarProps) {
    ...
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Image src="/eagle.png" alt="HG" width={34} height={34} style={{ objectFit: "contain", filter: "drop-shadow(0 2px 4px rgba(0,0,0,.35))" }} />
        </div>
        <div style={{ lineHeight: 1.1 }}>
          <div style={{ fontFamily: "Montserrat, system-ui", fontWeight: 800, fontSize: 15.5, letterSpacing: ".01em" }}>Tienda Escolar</div>
          <div style={{ fontSize: 11, color: "var(--hg-gold)", fontWeight: 700, fontFamily: "Montserrat, system-ui", letterSpacing: ".08em", textTransform: "uppercase" }}>Howard Gardner</div>
        </div>
      </div>
            ...
            return (
              ...
              >
                ...
                {it.id === "losses" && !isActive && (
                  <span style={{
                    background: "var(--hg-red)", color: "#fff", fontSize: 10.5, fontWeight: 800,
                    borderRadius: 8, minWidth: 19, height: 19, display: "flex",
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: 9, alignItems: "flex-start" }}>
              ...
              <div style={{ fontSize: 12, lineHeight: 1.4, color: "rgba(255,255,255,.85)" }}>
                <b style={{ fontFamily: "Montserrat, system-ui", color: "#fff" }}>Modo Caja.</b> Cobra rápido tocando los productos. Tu sesión se cierra sola a las 4:00 p.m.
              </div>
            </div>
          </div>
        )}
